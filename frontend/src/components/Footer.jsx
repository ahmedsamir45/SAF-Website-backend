      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">About SAF Education</h3>
            <p className="text-gray-400">
              Empowering students with quality education and opportunities for a brighter future.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to={ROUTES.PROGRAMS} className="text-gray-400 hover:text-white transition-colors">
                  Programs
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <address className="not-italic">
              <div className="flex items-start space-x-3 mb-3">
                <svg className="h-5 w-5 text-blue-400 mt-0.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <span className="text-gray-400">123 Education Street<br />Cairo, 11511<br />Egypt</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:info@saf-education.com" className="text-gray-400 hover:text-white transition-colors">
                  info@saf-education.com
                </a>
              </div>
            </address>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Subscribe to our newsletter to receive updates on new programs and events.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="md:flex md:items-center md:justify-between">
            <p className="text-center text-sm text-gray-400 md:text-left">
              &copy; {currentYear} SAF Education. All rights reserved.
            </p>
