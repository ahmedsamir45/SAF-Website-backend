...
DJOSER = {
    'SERIALIZERS': {
        'user_create': 'activities.serializer.UserCreateWithProfileSerializer',
        'user': 'activities.serializer.UserSerializer',
        'current_user': 'activitie.serializers.UserSerializer',
    },
